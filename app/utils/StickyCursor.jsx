  ...
  return (
    <>
      <motion.div
        ...
        className={`z-[6] fixed rounded-full flex justify-center ${isHeroHovered? 'backdrop-blur-sm': ''} items-center pointer-events-none bg-purple-500 cursor-auto mix-blend-difference`}
      >
