...
export default function ConfidentialPolitic() {
    ...
    return (
        <div className=" w-full flex flex-col z-[1] relative text-6xl py-8">
           <h1 className="tracking-tighter text-[210px] leadind-none pt-40">Politique de confidentialité</h1>
