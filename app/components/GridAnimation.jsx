...
export default function GridAnimation() {
    ...
    return (
        <div id='pricing' className='container h-full min-h-screen w-full flex flex-col items-center justify-center m-auto z-[1]' >
            <div ref={containerRef} className='w-[85vw]  m-auto mt-60 z-[1]'>
            <h1 className="text-[12.5em] mt-[5vh] z-[1] text-black">Nos Prestations</h1>
                ...
                <div className='w-full'>
                    <div className='card-img-container'>
                        ...
                        <div className=" flex flex-col items-start w-1/2 pl-10 mt-6">
                            <p className='text-4xl font-bold'>Web Site & Co</p>
                    ...
                    <div className='card-img-container justify-end'>
                        <div className=" flex flex-col items-end w-1/2 pr-10 mt-6">
                            <p className='text-4xl font-bold'>Refonte Site Web</p>
                    ...
                    <div className='card-img-container'>
                        ...
                        <div className=" flex flex-col items-start w-1/2 pl-10 mt-6">
                            <p className='text-4xl font-bold'>Référencement Web et SEO</p>
                    ...
                    <div className='card-img-container justify-end'>
                    <div className=" flex flex-col items-end w-1/2 pr-10 mt-6">
                            <p className='text-4xl font-bold'>Design Web</p>
