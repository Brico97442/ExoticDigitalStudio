...
function Footer() {
    ...
    return (
        <footer id='footer' className='flex h-[50vh]  justify-center items-center text-white w-full bg-black  z-[2] relative' style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}>
            ...
            <div className='fixed bottom-0 flex-col h-[50vh] text-white items-center justify-between w-full m-auto text-white px-[10px] lg:px-[50px] py-[10px] lg:py-[50px] bg-violet-500'>
                <div className='w-full bg-green-500'>
                    <Image src={logo} alt="logo de l'entreprise Exotik Digital Studio" width={100} height={80} className='z-[4]' />
                </div>

                <div className='z-[4] w-full flex justify-center flex-col-reverse lg:flex-row relative bg-red-500'>
                    <div className='flex flex-col justify-end z-[4] w-full text-[1rem] lg:text-[22px] gap-[5px] mt-[5px] lg:mt-[0px]'>
                        <p >Ile de la Réunion</p>
                        <p >Le Tampon</p>
                        <h2 >Politique de confidentialité</h2>
                        <h2>Mention Légales</h2>
                    </div>
                    <div className='z-[4] items-start justify-end flex flex-col gap-[5px]'>
                        <Magnetic>
