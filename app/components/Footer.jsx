...
function Footer() {
    ...
    return (
        <footer id='footer' className='flex h-[60vh]  justify-center items-center border-none text-white w-full bg-[#003049]  z-[2] relative' style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}>
            ...
            <div className='fixed bottom-0 flex flex-col lg:flex-row h-[60vh] text-white  lg:items-center w-full px-[20px] lg:px-[80px] py-[10px] lg:py-[80px]'>
                <div className='z-[4] w-full flex justify-between lg:justify-center flex-col-reverse lg:flex-row relative'>
                    ...
                    <div className='flex w-full'>
                        ...
                        <div className='z-[4] items-center  justify-start flex flex-col gap-[5px] w-1/3'>
                        ...
                        <div className=' flex flex-col z-[4] w-full lg:w-1/3 items-center justify-start text-[1rem] lg:text-[22px] gap-[5px] mt-[5px] lg:mt-[0px]'>
