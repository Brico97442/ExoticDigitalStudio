...
function Footer() {
    ...
    return (
        <footer id='footer' className='flex h-[60vh] justify-center items-center border-none text-white w-full bg-[#003049]  z-[2] relative' style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}>
            ...
            <p className='lg:absolute lg:bottom-[80px] right-[80px] text-1rem mix-blend-difference'>Une création Exotik Digital Studio</p>
            <div className='fixed bottom-0 flex flex-col lg:flex-row h-[60vh] text-white lg:items-center w-full px-[20px] lg:px-[80px] pb-[10px] lg:pb-[80px] '>
                <div className='z-[4] w-full flex justify-between lg:justify-center flex-col-reverse lg:flex-row relative'>
                    ...
                    <div className='flex w-full '>
                        <div className='z-[4] flex flex-col items-center  w-1/3'>
                            <h1 className='text-[1.2rem] lg:text-[26px] leading-none lg:pb-[50px] underline w-full text-center'>Navigation</h1>
                            <ul id='footer-navigation' className='text-[1rem] lg:text-[22px] flex flex-col items-end'>
                        ...
                        <div className='z-[4] items-end  justify-start flex flex-col gap-[5px] w-1/3 '>
                            <h1 className='text-[1.2rem] lg:text-[26px] leading-none lg:mb-[50px] underline'>Contact</h1>

                            <Magnetic>
                                <div>
                                    <p className='footer-link flex text-[1rem] lg:text-[22px] w-full cursor-pointer'>+ 262 692 58 59 99</p>
                                </div>
                            </Magnetic>
                            <Magnetic>
                                <button id='copy-text-btn'
                                    className='footer-link flex gap-6 text-[1rem] lg:text-[22px] text-white cursor-pointer transition ease-in-out z-[4] ' onClick={copyText} value="ExotikDigitalStudio@outlook.com" >
                        ...
                        <div className=' flex flex-col z-[4] w-full lg:w-1/3 items-end justify-start text-[1rem] lg:text-[22px] gap-[5px] mt-[5px] lg:mt-[0px]'>
                            <h1 className='text-[1.2rem] lg:text-[26px] leading-none lg:mb-[50px] underline invisible'>Liens utiles</h1>
                            <Magnetic>
                                <TransitionLink href="/mentions-legales">
                                    <h2 className='footer-link text-nowrap cursor-pointer'>Mention Légales</h2>
                                </TransitionLink>
                            </Magnetic>
                            <Magnetic>
                                <TransitionLink href="/politique-de-confidentialite">
                                    <h2 className='footer-link text-nowrap cursor-pointer '>Politique de confidentialité</h2>
                                </TransitionLink>
                ...
                <div className='flex w-full relative lg:absolute bottom-[0px] lg:bottom-[80px] z-[4] justify-center gap-6'>
