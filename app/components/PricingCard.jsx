...
function PricingCard({ title, features, price }) {
    return (
        <div className='relative w-[385px] mi-h-[570px]  flex justify-center rounded-[20px] p-[2px]'>
           <div className='backdrop-blur-[100px]  bg-opacity-50 w-full h-auto rounded-[20px] p-[35px] hover:bg-gray-400 transition duration-500'>
