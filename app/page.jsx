      ...
      <div className="z-[1] flex w-full h-full min-h-screen flex-col relative">
        ...
        <div ref={heroSection} id='hero' className='h-screen sticky w-full flex flex-col  items-center top-0 z-[6]'>
          <div className='h-screen flex flex-col items-start justify-between w-full px-[20px] lg:px-[50px] pt-[0px] lg:pt-[100px] relative'>
            ...
            <h2 id='hero-subtitle' className=' pointer-events-none mt-[20px] leading-none text-[28px] w-full tracking-tighter lg:w-1/4 lg:text-[31px] mt-[40px] '>Offrez à vos visiteurs une expérience web captivante, parce que chaque clic mérite sa touche de magie.</h2>
            <h1 id='hero-title' className='absolute right-[20px] bottom-[20px] pointer-events-none leading-none text-[24px] font-bold-sm tracking-tighter lg:bottom-[20px] lg:right-[50px]'>Reunion Island Digital Studio </h1>
            ...
            <div className=" absolute right-0 bottom-[15vh] flex flex-col items-end justify-center mr-[20px] lg:mr-[50px]  ">
              <div id="coordinates-gps" className="flex flex-col items-end text-[16px] tracking-tighter leaading-none">
                <p>21° 16' 41″ S </p>
                <p>55° 30' 55″ E</p>
              </div>
            </div>
            <h2 style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }} id='studio-text' className='absolute bottom-0 right-0 pointer-events-none leading-none text-[24px] font-bold-sm tracking-tighter text-black mr-[20px] mb-[20px] lg:mr-[50px] mb-[50px]'>Créateur de solutions digitales</h2>
          </div>
          <HorizontalScroll />
        </div>
