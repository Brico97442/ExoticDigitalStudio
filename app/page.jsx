      ...
      {animationComplete && (
        <div className="z-[1] flex w-full h-full min-h-screen flex-col relative">
          ...
          <Scene island={island}/>
            ...
            <div className='flex flex-col items-start justify-between mt-[40px] w-full h-full px-[80px] pt-[100px] relative'>
              ...
              <h3 id='hero-subtitle' className=' pointer-events-none mt-[60px] leading-none text-[48px]  w-1/3 uppercase	tracking-tighter '>Offrez à vos visiteurs une expérience web captivante, parce que chaque clic mérite sa touche de magie.</h3>
          ...
          <div id="about" ref={aboutRef} className=" sticky top-0 h-screen flex flex-col justify-center items-start w-full  rounded-tl-[50px] rounded-tr-[50px] top-0  bg-[#ECECEC] z-[2]">
              ...
              <div className='h-full w-full flex flex-col justify-between'>
                <div className="w-full flex justify-end">
                  <p ref={target} id='target-text' className='flex w-1/2 h-full justify-center text-[24px] text-right'>
                    ...
                    Vous cherchez une touche d’exception pour votre site web ? Ne cherchez pas plus loin, nous avons la recette parfaite !
                  </p>
                </div>
