...
export default function Home() {
  ...
  return (
    <main id="main" className="flex w-full h-full relative min-h-screen flex-col overflow-hidden ">
      ...
      { animationComplete && (
        <div className="z-[1]">
        <div id='hero' className=' w-full flex flex-col  items-center relative top-0 sticky z-[1]'>
          ...
          <h2 className='mt-[100px] pointer-events-none leading-none text-[16px] tracking-tighter  w-full text-black '>Reunion Island Studio **</h2>
          </div>
          <HorizontalScroll />
          </div>
        <div id="about" className="h-screen flex flex-col justify-center items-start w-full relative  bg-red-600 rounded-tl-[50px] rounded-tr-[50px] top-0 z-[1]">
          <div className=" flex flex-col items-start  h-full w-[85vw] m-auto" >
          <h1 id='about-title' className='text-[150px]  bg-clip-text text-align-left tracking-tight my-20 bg-gradient-to-r from-black to-neutral-950/80'>Qui somme nous ?</h1>
          ...
          <div id="contact" className="max-w-[85vw] m-auto w-full min-h-screen relative z-[1]">
            <h1 className="text-[12.5em] mt-10 mb-10 leading-none z-[1]">Démarrons</h1>
            <h1 className="text-[12.5em] mb-10 leading-none z-[1]">un projet</h1>
